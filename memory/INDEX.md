...
**Fase 4 fechada. Próxima = fase 5 (clima: fog → clouds → water → rain).** Não comecees mesh shaders, RT, FSR, editor. Cena de referência: **Sponza** (`docs/Rust-Rewrite-Roadmap.md` §0.1).
